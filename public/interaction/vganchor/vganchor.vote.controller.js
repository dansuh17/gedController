 ...
 */
((function vganchorVoteController() {
  angular
      .module('vganchor')
      .controller('vganchorVoteCtrl', ['$scope', '$timeout', 'socketFactory',
        function vganchorVoteCtrlCallback($scope, $timeout, socketFactory) {
          ...
          $scope.switchVote = function () {
            ...
            socketFactory.emit('giveVoteStatus',
                { status: $scope.status, prevStatus: currentStatus });
          };
